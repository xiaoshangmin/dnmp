...
apk --no-cache add git file-dev imagemagick-dev imagemagick gettext-dev libzip-dev icu-dev freetype freetype-dev libpng libpng-dev libjpeg-turbo libjpeg-turbo-dev libwebp-dev libxml2-dev
